...
func _open_lesson(node_id: String) -> void:
	...
	var completed_lessons : Array = SecureDataManager.data.get("completed_lessons", {}).get("sao_truc", [])
	if completed_lessons.has(node_id):
		# Create a popup programmatically
		var popup := PanelContainer.new()
		var s_panel := StyleBoxFlat.new()
		s_panel.bg_color = Color(1, 1, 1, 0.95)
		s_panel.corner_radius_top_left = 20
		s_panel.corner_radius_top_right = 20
		s_panel.corner_radius_bottom_left = 20
		s_panel.corner_radius_bottom_right = 20
		s_panel.border_width_left = 2
		s_panel.border_width_right = 2
		s_panel.border_width_top = 2
		s_panel.border_width_bottom = 2
		...
		s_btn_learn.corner_radius_top_left = 12
		s_btn_learn.corner_radius_top_right = 12
		s_btn_learn.corner_radius_bottom_left = 12
		s_btn_learn.corner_radius_bottom_right = 12
		...
		s_btn_challenge.corner_radius_top_left = 12
		s_btn_challenge.corner_radius_top_right = 12
		s_btn_challenge.corner_radius_bottom_left = 12
		s_btn_challenge.corner_radius_bottom_right = 12
		...
		btn_cancel.add_theme_color_override("font_color", C_TEXT_MUTED)
