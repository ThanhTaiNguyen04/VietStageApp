...
const LESSON_NOTES = preload("res://scripts/SaoTrucBundledLessonData.gd").LESSON_NOTES

const LESSON_DIALOGUES = preload("res://scripts/SaoTrucBundledLessonData.gd").LESSON_DIALOGUES
