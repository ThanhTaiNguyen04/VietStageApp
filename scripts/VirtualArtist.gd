...
const HIDDEN_SCENES := ["SplashScreen", "LoadingScreen", "LoginScreen", "InstrumentSelect", "VirtualMusicRoom", "PracticeRoom", "PracticeSaoTruc", "PracticeDanBau", "VideoPlayer", "MainMenu", "CourseMap", "SongScreen", "AccountScreen", "ProgressScreen"]
